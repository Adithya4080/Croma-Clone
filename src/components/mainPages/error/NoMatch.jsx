...
export default function NoMatch() {
    return (
        <div>
            ...
            <Navbar />
            <div className='flex justify-center items-center mt-40 mb-20 text-white'>
                <div>
                    <div>
                    ...
                    <div className='mt-12'>
                        ...
                        <Link to='/'><button className='border border-white px-20 py-1 rounded-lg mt-2 text-xl font-semibold'>Retry</button></Link>
                    </div> 
                </div>               
            </div>
            <Footer />
